...
import com.truongngocde.adapter.MessageAdapter;
import com.truongngocde.models.GetTimeAgo;
import com.truongngocde.models.Message;
...
//**********************************************************************************************
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == GALARY_PICK && resultCode == RESULT_OK) {
            ...
            UploadImageInStorageDataBase(imageUri);
        }
    }

    private void UploadImageInStorageDataBase(Uri imageUri) {
        // Tải ảnh lên cơ sở dữ liệu lưu trữ
        ...
        filePath.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
                    public void onSuccess(Uri uri) {
                        // Lưu đường dẫn tải xuống ảnh vào child "Image"
